...
public class SystemUtil {
     ...
     * 检查WIFI是否连接
     */
    public static boolean isWifiConnected(Application context) {
     ...
     */
    public static boolean isMobileNetworkConnected(Application context) {
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static Uri saveBitmapToFile(Context context, String url, Bitmap bitmap, View container, boolean isShare) {
        ...
        File fileDir = new File(Constants.PATH_SDCARD + context.getPackageName());
        if (!fileDir.exists()) {
            fileDir.mkdirs();
        }
